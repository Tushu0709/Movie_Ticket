...
const TrailerSection = () => {
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
      <h2 className="text-gray-300 font-medium text-lg max-w-[960px] mx-auto mb-8">
        Trailers
      </h2>
      ...
      <div className="relative mt-6">
        ...
        <div className="relative w-full max-w-[960px] mx-auto aspect-video rounded-2xl overflow-hidden shadow-lg bg-black">
          <ReactPlayer
